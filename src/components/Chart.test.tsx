...
vi.mock('../services/useStore', () => {
  return {
    useStore: () => ({
      portfolio: [
        { id: '1', symbol: 'A', qty: 2, avgPrice: 10, currentPrice: 11, history: [ { time: '2026-04-20', value: 20 }, { time: '2026-05-01', value: 22 } ] },
        { id: '2', symbol: 'B', qty: 1, avgPrice: 5, currentPrice: 6, history: [ { time: '2026-04-20', value: 5 }, { time: '2026-05-01', value: 6 } ] }
      ],
      portfolioHistory: [
        { time: '2026-04-20', value: 45 },
        { time: '2026-05-01', value: 50 }
      ],
